...
class App(ctk.CTk):
    ...
    def on_key_release(self, *args):
        ...
        scrollbar_position = self.code_textbox.yview()[0]
        ...
        # Restaurar la posición del scrollbar
        self.code_textbox.yview_moveto(scrollbar_position)

        # Actualizar otros elementos de la interfaz
        self.enlazar_scroll()
        self.actualizar_posicion_cursor()
